...
//wk12
//ORDER SERACH
export const BEGIN_USERORDER_REQUEST = "BEGIN_USERORDER_REQUEST";
export const SUCCESS_USERORDER_REQUEST = "SUCCESS_USERORDER_REQUEST";
export const FAIL_USERORDER_REQUEST = "FAIL_USERORDER_REQUEST";

export const SET_USERORDER_CONTENT = "SET_USERORDER_CONTENT";
export const SET_SEARCHED_DETAIL = "SET_SEARCHED_DETAIL";
